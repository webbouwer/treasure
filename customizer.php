...
function treasure_customizer_init( $wp_customize ){
  ...
  // global panel
	$wp_customize->add_section('static_front_page', array(
		...
		'priority' => 30,
	));    $wp_customize->add_section('treasure_custom_code', array(      'title'    => __('Global custom code', 'treasure'),      'panel'  => 'treasure_global',      'priority' => 10,    ));
  // identity panel
  ...
  // footer panel
    ...
    )));  $wp_customize->add_setting( 'treasure_global_code_content' , array(      'default' => '',      'sanitize_callback' => 'treasure_sanitize_default',    ));    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'treasure_global_code_content', array(     	'label'          => __( 'Custom body code', 'treasure' ),     	'section'        => 'treasure_custom_code',     	'settings'       => 'treasure_global_code_content',     	'type'           => 'textarea',    	'description'    => __( 'Add custom code (like analytics js)', 'treasure' ),    )));
