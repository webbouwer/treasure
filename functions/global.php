...
// register custom code input
function theme_custom_body_code(){
 $code = get_theme_mod( 'treasure_global_code_content', false );
 if($code){
   echo $code;	
 }
}
add_action( 'wp_body_open', 'theme_custom_body_code' );
//add_action( 'wp_footer', 'theme_custom_body_code' );
